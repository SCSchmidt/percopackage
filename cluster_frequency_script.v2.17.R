...
#		sub=paste("Source File: ",source_file_name),
		...
		ylab="max cluster size", type="b", bg=NA, lwd=2,
		cex.main=1.5, cex.lab=2, cex.axis=1.5)
	box(lwd=2)
	...
	# Plot radius vs max_clust_size, with simple line
	plot(analysis_by_radius$radius,analysis_by_radius$max_clust_size,
		main=paste("Max cluster size vs radius ",plot_suffix),
#		sub=paste("Source File: ",source_file_name),
		xlab=paste("radius ", unit_text),
		ylab="max cluster size", type="l", bg=NA, lwd=2,
		cex.main=1.5, cex.lab=2, cex.axis=1.5)
	box(lwd=2)
	minor.tick(nx=10,  ny=10, tick.ratio  = 0.6)
	#lines(analysis_by_radius$radius,analysis_by_radius$max_clust_size, type="l")
...
#		sub=paste("Source File: ",source_file_name),
		xlab=paste("radius ", unit_text),
		ylab="max cluster size (normalized)", type="b", lwd=2,
		cex.main=1.5, cex.lab=2, cex.axis=1.5)
	box(lwd=2)
	#lines(analysis_by_radius$radius,analysis_by_radius$max_normalized, type="b", bg=NA)
	textxy(analysis_by_radius$radius,analysis_by_radius$max_normalized,analysis_by_radius$radius, col="red", cex=.8)

	# Plot radius vs number of clusters
	plot(analysis_by_radius$radius,analysis_by_radius$num_clust,
		main=paste("Number of clusters vs radius ",plot_suffix),
#		sub=paste("Source File: ",source_file_name),
		xlab=paste("radius ", unit_text),
		ylab="number of clusters", type="l", bg=NA, lwd=2,
		cex.main=1.5, cex.lab=2, cex.axis=1.5)
	minor.tick(nx=10,  ny=10, tick.ratio  = 0.6)
	box(lwd=2)
	#lines(analysis_by_radius$radius,analysis_by_radius$num_clust, type="b")

...
To the naked eye it is visible that there are different turning points at which the distribution flattens. This is a sign of different levels of clustering inside the sites. The final flattening might be interpreted as the algorithm running out of features to add to the clusters. We thereby find the edges of settlements and can define their size.

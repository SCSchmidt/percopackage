...
print(paste("Radii used for cluster analysis, km: upper ",upper_radius,
...
for (i in radius_values)
{
	...
	matrix_radius <- matrix_IDs_distance[matrix_IDs_distance[,3]<=i,]
	...
	new_col_name <- paste("ClstRad",i,sep="")
...
#	mem_clust_by_r[is.na(mem_clust_by_r)] <- 0
	...
	print(paste("for distance i=",i,"it took to compute",sprintf("%4.2f",t_print),"mins"))

...
data_NA <- data[rowSums(is.na(data)) > 0,] # next lines not needed, 'cause I don't have missing values
...
# Write list to file
duplicate_xy <- data[duplicated(data[,2:3]),] # duplicate points are only a problem for my EZ/sBZ - points -> not needed for SNL!
